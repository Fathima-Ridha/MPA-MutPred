...
##################################################################################################################################################################################
			...
			t= "/home/fathima/mutMPApred_server/foldx_20241231 --command=BuildModel --pdb="+pdb_id_up+".pdb --mutant-file=individual_list.txt"
			print (t)
			os.system(t)
			...
			df = pd.read_csv("/home/fathima/mutMPApred_server/49_prop_req.csv", sep='\t', index_col=0)
...
##################################################################################################################################################################################	
			...
			# PSSM
			os.system("/usr/bin/psiblast -query input_seq.fasta -db /home/fathima/mutMPApred_server/uniprot_db/uniprot_sprot.fasta -out input_seq_pssm.out -num_iterations 3 -num_threads 8 -out_ascii_pssm input_seq_out.pssm")
...
##################################################################################################################################################################################	
			...
			loaded_model = joblib.load('/home/fathima/mutMPApred_server/trained_gb_model.pkl')
